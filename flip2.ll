...
define fastcc %ort @testFunc(%ort %xArg, %ort %yArg) nounwind {
...
define fastcc %ort @flip(%ort nest %f, ) {
  %1 = bitcast %ort (%ort, %ort)* %f to %ort
  %2 = insertvalue %func3 undef, %ort %1, 0
  ret %func3 %2
}

define fastcc %func3 @flip1(%func3 %struct, %ort %arg) {
    %1 = insertvalue %func3 %struct, %ort %arg, 1
	ret %func3 %1
}

define fastcc %ort @flip2(%func3 %struct, %ort %arg) {
